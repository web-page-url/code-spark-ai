...
export default function DocsPage() {
  ...
  // Handle scroll for back to top button and progress indicator
  React.useEffect(() => {
    const handleScroll = () => {
  ...
  const sections = [
    ...
    { id: 'workspace', title: '🎛️ Workspace Management', icon: '🎛️' },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <nav aria-label="Breadcrumb" className="bg-gray-900/50 border-b border-gray-700/50">
        <div className="container mx-auto px-6 py-3">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li>
              <span className="text-gray-300" aria-current="page">Documentation</span>
            </li>
          </ol>
        </div>
      </nav>
      {/* Hero Section */}
      <header className="docs-hero-gradient border-b border-gray-600/50">
        <div className="container mx-auto px-6 py-16">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-4 mb-6">
              <span className="text-6xl animate-pulse animate-float" role="img" aria-label="Lightning bolt">⚡</span>
              <h1 className="text-5xl font-black bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 bg-clip-text text-transparent text-glow">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link 
                href="/"
                className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg flex items-center space-x-2"
              >
                <span>💻</span>
              ...
              <button
                ...
                className="px-8 py-3 bg-gray-800/50 hover:bg-gray-700/50 border border-gray-600/50 text-gray-300 hover:text-white font-medium rounded-lg transition-all duration-200 flex items-center space-x-2"
              >
                <span>📖</span>
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Sidebar Navigation */}
          <aside className="lg:w-80 space-y-2" aria-label="Documentation navigation">
            ...
            {activeSection === 'getting-started' && (
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="docs-card bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-blue-600/30 rounded-xl p-6">
                    ...
                    <div className="mt-3 text-xs text-blue-300">
                      <span className="docs-feature-tag px-2 py-1 rounded">Semantic Elements</span>
                      <span className="docs-feature-tag px-2 py-1 rounded ml-1">Accessibility</span>
                    </div>
                  </div>

                  <div className="docs-card bg-gradient-to-br from-pink-900/30 to-red-900/30 border border-pink-600/30 rounded-xl p-6">
                    ...
                    <div className="mt-3 text-xs text-pink-300">
                      <span className="docs-feature-tag px-2 py-1 rounded">Flexbox</span>
                      <span className="docs-feature-tag px-2 py-1 rounded ml-1">Animations</span>
                    </div>
                  </div>

                  <div className="docs-card bg-gradient-to-br from-yellow-900/30 to-orange-900/30 border border-yellow-600/30 rounded-xl p-6">
                    ...
                    <div className="mt-3 text-xs text-yellow-300">
                      <span className="docs-feature-tag px-2 py-1 rounded">ES6+</span>
                      <span className="docs-feature-tag px-2 py-1 rounded ml-1">DOM APIs</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {showBackToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 p-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 animate-float"
          title="Back to top"
        >
      ...
      {/* Progress Indicator */}
      <div className="docs-scroll-indicator" style={{ 
